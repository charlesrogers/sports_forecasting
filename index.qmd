...
renderPlot({
  ...
  new_game_predictions <- predict_new_game(new_game, results$individual_models, results$ensemble_model, results$team_performance)
...
renderText({
  ...
  paste("Ensemble prediction: ", round(new_game_predictions["Ensemble"] * 100, 2), "% chance of home team win")
})
```
